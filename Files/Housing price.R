...
train<- read.csv("C:\\Users\\Narasimha\\Downloads\\train.csv",header = T,stringsAsFactors = F)
test <- read.csv("C:\\Users\\Narasimha\\Downloads\\test.csv",header = T,stringsAsFactors = F)
